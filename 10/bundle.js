...
const generateTime = date => {
  const duration = (0,_utils_date_manipulation_js__WEBPACK_IMPORTED_MODULE_2__.getDiffDates)(date.dataBeginEvent, date.dataEndEvent);
  let durationFormat = '';
...
const generateOffers = () => {
  typeRoutes.forEach(typeRoute => {
    ...
    let countOffers = (0,_utils_common_js__WEBPACK_IMPORTED_MODULE_1__.getRandomNumber)(0, 5);

    for (let i = 0; i < offersTitle.length; i++) {
      const numberElement = (0,_utils_common_js__WEBPACK_IMPORTED_MODULE_1__.getRandomNumber)(0, cloneOfferTitle.length - 1);
...
const generateEvents = () => {
  ...
  const type = {
    currentType: typeRoutes[(0,_utils_common_js__WEBPACK_IMPORTED_MODULE_1__.getRandomNumber)(0, 7)],
    arrayType: typeRoutes
  };
  const allPrice = type.currentType.allPriceOffers + (0,_utils_common_js__WEBPACK_IMPORTED_MODULE_1__.getRandomNumber)(10, 30);
  return {
    id: (0,nanoid__WEBPACK_IMPORTED_MODULE_3__.nanoid)(),
    date,
    type,
    city: {
      currentCity: cityes[(0,_utils_common_js__WEBPACK_IMPORTED_MODULE_1__.getRandomNumber)(0, 2)],
      arrayCity: cityes
    },
    time,
    allPrice,
...
/* harmony import */ var _view_event_offer_view_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../view/event-offer-view.js */ "./src/view/event-offer-view.js");
  ...
  constructor(eventListContainer, changeData, changeMode) {
    ...
    _defineProperty(this, "init", tripEvent => {
      ...
      if (prevEventComponent === null || prevEventEditComponent === null) {
        (0,_render_js__WEBPACK_IMPORTED_MODULE_3__.render)(_classPrivateFieldGet(this, _eventListContainer), _classPrivateFieldGet(this, _eventComponent), _render_js__WEBPACK_IMPORTED_MODULE_3__.RenderPosition.BEFOREEND);
      ...
      if (_classPrivateFieldGet(this, _mode) === Mode.DEFAULT) {
        (0,_render_js__WEBPACK_IMPORTED_MODULE_3__.replace)(_classPrivateFieldGet(this, _eventComponent), prevEventComponent);

        _classPrivateFieldGet(this, _renderOffers).call(this);
      }

      if (_classPrivateFieldGet(this, _mode) === Mode.EDITING) {
        (0,_render_js__WEBPACK_IMPORTED_MODULE_3__.replace)(_classPrivateFieldGet(this, _eventEditComponent), prevEventEditComponent);
      }

      (0,_render_js__WEBPACK_IMPORTED_MODULE_3__.remove)(prevEventComponent);
      (0,_render_js__WEBPACK_IMPORTED_MODULE_3__.remove)(prevEventEditComponent);
    });
    ...
    _defineProperty(this, "destroy", () => {
      (0,_render_js__WEBPACK_IMPORTED_MODULE_3__.remove)(_classPrivateFieldGet(this, _eventComponent));
      (0,_render_js__WEBPACK_IMPORTED_MODULE_3__.remove)(_classPrivateFieldGet(this, _eventEditComponent));
    });
    ...
    _classPrivateFieldInitSpec(this, _replaceEventToEditPoint, {
      writable: true,
      value: () => {
        (0,_render_js__WEBPACK_IMPORTED_MODULE_3__.replace)(_classPrivateFieldGet(this, _eventEditComponent), _classPrivateFieldGet(this, _eventComponent));
    ...
    _classPrivateFieldInitSpec(this, _replaceEditPointToEvent, {
      writable: true,
      value: () => {
        _classPrivateFieldGet(this, _eventEditComponent).reset(_classPrivateFieldGet(this, _tripEvent));

        (0,_render_js__WEBPACK_IMPORTED_MODULE_3__.replace)(_classPrivateFieldGet(this, _eventComponent), _classPrivateFieldGet(this, _eventEditComponent));
        document.removeEventListener('keydown', _classPrivateFieldGet(this, _onEscKeyDown));
    ...
    _classPrivateFieldInitSpec(this, _renderOffers, {
      ...
      value: () => {
        ...
        _classPrivateFieldGet(this, _tripEvent).type.currentType.selectedOffer.forEach(offer => (0,_render_js__WEBPACK_IMPORTED_MODULE_3__.render)(selectedOffers, new _view_event_offer_view_js__WEBPACK_IMPORTED_MODULE_2__["default"](offer), _render_js__WEBPACK_IMPORTED_MODULE_3__.RenderPosition.BEFOREEND));
      }
    });
...
var _cityChangeHandler = /*#__PURE__*/new WeakMap();

var _typeChangeHandler = /*#__PURE__*/new WeakMap();

var _clickHandler = /*#__PURE__*/new WeakMap();

var _formSubmitHandler = /*#__PURE__*/new WeakMap();

class EditPoint extends _smart_view_js__WEBPACK_IMPORTED_MODULE_1__["default"] {
  constructor(editPoint) {
    ...
    _defineProperty(this, "reset", task => {
    ...
    _classPrivateFieldInitSpec(this, _setInnerHandlers, {
      writable: true,
      value: () => {
        this.element.querySelector('.event__type-group').addEventListener('change', _classPrivateFieldGet(this, _typeChangeHandler));
        this.element.querySelector('.event__input--destination').addEventListener('change', _classPrivateFieldGet(this, _cityChangeHandler));
      }
    });

    _classPrivateFieldInitSpec(this, _cityChangeHandler, {
      writable: true,
      value: evt => {
        this.updateData({
          city: {
    ...
    _classPrivateFieldInitSpec(this, _typeChangeHandler, {
      writable: true,
      value: evt => {
        this.updateData({
          type: {
