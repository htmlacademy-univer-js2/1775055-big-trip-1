...
/* harmony import */ var _view_add_photo_tape_view_js__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ./view/add-photo-tape-view.js */ "./src/view/add-photo-tape-view.js");
...
(0,_render_js__WEBPACK_IMPORTED_MODULE_10__.render)(siteMainElement, new _view_sort_view_js__WEBPACK_IMPORTED_MODULE_6__["default"]().element, _render_js__WEBPACK_IMPORTED_MODULE_10__.RenderPosition.BEFOREEND);
(0,_render_js__WEBPACK_IMPORTED_MODULE_10__.render)(siteMainElement, new _view_list_event_view_js__WEBPACK_IMPORTED_MODULE_2__["default"]().element, _render_js__WEBPACK_IMPORTED_MODULE_10__.RenderPosition.BEFOREEND);
...
const renderEvent = (eventListElement, event) => {
  ...
  eventComponent.element.querySelector('.event__rollup-btn').addEventListener('click', () => {
    ...
    for (let i = 0; i < event.offers.length; i++) {
      (0,_render_js__WEBPACK_IMPORTED_MODULE_10__.render)(availableOffers, new _view_offer_edit_and_new_point_js__WEBPACK_IMPORTED_MODULE_5__["default"](event.offers[i]).element, _render_js__WEBPACK_IMPORTED_MODULE_10__.RenderPosition.BEFOREEND);
    }
  });
  ...
  (0,_render_js__WEBPACK_IMPORTED_MODULE_10__.render)(eventListElement, eventComponent.element, _render_js__WEBPACK_IMPORTED_MODULE_10__.RenderPosition.BEFOREEND);
};
...
for (let i = 0; i < routeCount; i++) {
  for (let j = 0; j < routes[i].offers.length; j++) {
    (0,_render_js__WEBPACK_IMPORTED_MODULE_10__.render)(selectedOffers[i], new _view_event_offer_view_js__WEBPACK_IMPORTED_MODULE_4__["default"](routes[i].offers[j]).element, _render_js__WEBPACK_IMPORTED_MODULE_10__.RenderPosition.BEFOREEND);
  }
}
})();
