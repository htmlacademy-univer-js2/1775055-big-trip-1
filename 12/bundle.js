...
const generateDate = () => {
  const maxDaysGag = 7;
  const daysGap = (0,_utils_common_js__WEBPACK_IMPORTED_MODULE_1__.getRandomNumber)(-7, maxDaysGag);
...
class EventsModel extends _utils_abstract_observable_js__WEBPACK_IMPORTED_MODULE_0__["default"] {
  constructor(...args) {
    super(...args);
    ...
    _defineProperty(this, "updateEvent", (updateType, update) => {
      const index = _classPrivateFieldGet(this, _events).findIndex(event => event.id === update.id);

      if (index === -1) {
        throw new Error('Can\'t update unexisting event');
      }

      _classPrivateFieldSet(this, _events, [..._classPrivateFieldGet(this, _events).slice(0, index), update, ..._classPrivateFieldGet(this, _events).slice(index + 1)]);

      this._notify(updateType, update);
    });

    _defineProperty(this, "addEvent", (updateType, update) => {
      _classPrivateFieldSet(this, _events, [update, ..._classPrivateFieldGet(this, _events)]);
    ...
    _defineProperty(this, "deleteEvents", (updateType, update) => {
      ...
      _classPrivateFieldSet(this, _events, [..._classPrivateFieldGet(this, _events).slice(0, index), ..._classPrivateFieldGet(this, _events).slice(index + 1)]);
...
/***/ "./src/presentor/event-new-presentor.js":
/*!**********************************************!*\
  !*** ./src/presentor/event-new-presentor.js ***!
  \**********************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/* harmony export */ });
/* harmony import */ var _view_edit_point_view_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../view/edit-point-view.js */ "./src/view/edit-point-view.js");
/* harmony import */ var nanoid__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! nanoid */ "./node_modules/nanoid/index.dev.js");
/* harmony import */ var _const_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../const.js */ "./src/const.js");
...
class EventNewPresenter {
  constructor(eventListContainer, changeData) {
    ...
    _defineProperty(this, "init", tripEvent => {
      ...
      if (_classPrivateFieldGet(this, _eventEditComponent) !== null) {
        return;
      }

      _classPrivateFieldSet(this, _eventEditComponent, new _view_edit_point_view_js__WEBPACK_IMPORTED_MODULE_0__["default"](_classPrivateFieldGet(this, _tripEvent)));

      _classPrivateFieldGet(this, _eventEditComponent).setClickRollupHandler(_classPrivateFieldGet(this, _handleDeleteClick));

      _classPrivateFieldGet(this, _eventEditComponent).setFormSubmitHadler(_classPrivateFieldGet(this, _handleFormSubmit));

      _classPrivateFieldGet(this, _eventEditComponent).setDeleteClickHandler(_classPrivateFieldGet(this, _handleDeleteClick));

      (0,_render_js__WEBPACK_IMPORTED_MODULE_2__.render)(_classPrivateFieldGet(this, _eventListContainer), _classPrivateFieldGet(this, _eventEditComponent), _render_js__WEBPACK_IMPORTED_MODULE_2__.RenderPosition.AFTERBEGIN);
    ...
    _defineProperty(this, "destroy", () => {
      ...
      (0,_render_js__WEBPACK_IMPORTED_MODULE_2__.remove)(_classPrivateFieldGet(this, _eventEditComponent));

      _classPrivateFieldSet(this, _eventEditComponent, null);
    ...
    _classPrivateFieldInitSpec(this, _handleFormSubmit, {
      writable: true,
      value: event => {
        _classPrivateFieldGet(this, _changeData).call(this, _const_js__WEBPACK_IMPORTED_MODULE_1__.UserAction.ADD_EVENT, _const_js__WEBPACK_IMPORTED_MODULE_1__.UpdateType.MINOR, // Пока у нас нет сервера, который бы после сохранения
...
/* harmony import */ var _utils_date_manipulation_js__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../utils/date-manipulation.js */ "./src/utils/date-manipulation.js");
  ...
  constructor(eventListContainer, changeData, changeMode) {
    ...
    _classPrivateFieldInitSpec(this, _handleFavoriteClick, {
      ...
      value: () => {
        ...
        _classPrivateFieldGet(this, _changeData).call(this, _const_js__WEBPACK_IMPORTED_MODULE_2__.UserAction.UPDATE_EVENT, _const_js__WEBPACK_IMPORTED_MODULE_2__.UpdateType.PATCH, { ..._classPrivateFieldGet(this, _tripEvent),
          favorite: !_classPrivateFieldGet(this, _tripEvent).favorite
        });
      }
    });
    ...
    _classPrivateFieldInitSpec(this, _handleFormSubmit, {
      writable: true,
      value: update => {
        const isMinorUpdate = !(0,_utils_date_manipulation_js__WEBPACK_IMPORTED_MODULE_3__.isDatesEqual)(_classPrivateFieldGet(this, _tripEvent).date.dataBeginEvent, update.date.dataBeginEvent) || !(0,_utils_date_manipulation_js__WEBPACK_IMPORTED_MODULE_3__.isDatesEqual)(_classPrivateFieldGet(this, _tripEvent).date.dataEndEvent, update.date.dataEndEvent);

        _classPrivateFieldGet(this, _changeData).call(this, _const_js__WEBPACK_IMPORTED_MODULE_2__.UserAction.UPDATE_EVENT, isMinorUpdate ? _const_js__WEBPACK_IMPORTED_MODULE_2__.UpdateType.MINOR : _const_js__WEBPACK_IMPORTED_MODULE_2__.UpdateType.PATCH, update);
    ...
    _classPrivateFieldInitSpec(this, _handleDeleteClick, {
      writable: true,
      value: event => {
        _classPrivateFieldGet(this, _changeData).call(this, _const_js__WEBPACK_IMPORTED_MODULE_2__.UserAction.DELETE_EVENT, _const_js__WEBPACK_IMPORTED_MODULE_2__.UpdateType.MINOR, event);
      }
    });
...
/***/ "./src/presentor/filter-presentor.js":
/*!*******************************************!*\
  !*** ./src/presentor/filter-presentor.js ***!
  \*******************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/* harmony export */ });
/* harmony import */ var _view_filter_view_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../view/filter-view.js */ "./src/view/filter-view.js");
...
class FilterPresenter {
  constructor(filterContainer, filterModel) {
    ...
    _defineProperty(this, "init", () => {
      ...
      _classPrivateFieldSet(this, _filterComponent, new _view_filter_view_js__WEBPACK_IMPORTED_MODULE_0__["default"](_classPrivateFieldGet(this, _filterModel).filter));
      ...
      if (prevFilterComponent === null) {
        (0,_render_js__WEBPACK_IMPORTED_MODULE_1__.render)(_classPrivateFieldGet(this, _filterContainer), _classPrivateFieldGet(this, _filterComponent), _render_js__WEBPACK_IMPORTED_MODULE_1__.RenderPosition.BEFOREEND);
        return;
      }

      (0,_render_js__WEBPACK_IMPORTED_MODULE_1__.replace)(_classPrivateFieldGet(this, _filterComponent), prevFilterComponent);
      (0,_render_js__WEBPACK_IMPORTED_MODULE_1__.remove)(prevFilterComponent);
    });
...
/* harmony import */ var _view_list_event_view_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../view/list-event-view.js */ "./src/view/list-event-view.js");
...
/* harmony import */ var _view_event_empty_js__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../view/event-empty.js */ "./src/view/event-empty.js");
/* harmony import */ var _event_presenter_js__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./event-presenter.js */ "./src/presentor/event-presenter.js");
/* harmony import */ var _event_new_presentor_js__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./event-new-presentor.js */ "./src/presentor/event-new-presentor.js");
/* harmony import */ var _const_js__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ../const.js */ "./src/const.js");
/* harmony import */ var _utils_filter_js__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ../utils/filter.js */ "./src/utils/filter.js");
/* harmony import */ var _mock_event_js__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ../mock/event.js */ "./src/mock/event.js");
/* harmony import */ var _utils_sorting_js__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ../utils/sorting.js */ "./src/utils/sorting.js");
...
var _eventNewPresenter = /*#__PURE__*/new WeakMap();

var _currentSortType = /*#__PURE__*/new WeakMap();

var _eventsModel = /*#__PURE__*/new WeakMap();
...
var _clearBoard = /*#__PURE__*/new WeakMap();
...
class TripPresenter {
  constructor(tripContainer, menuContainer, eventsModel, filterModel) {
    ...
    _classPrivateFieldInitSpec(this, _eventNewPresenter, {
      writable: true,
      value: null
    });
    ...
    _classPrivateFieldInitSpec(this, _currentSortType, {
      writable: true,
      value: _utils_sorting_js__WEBPACK_IMPORTED_MODULE_9__.SortType.DAY.text
    });

    _classPrivateFieldInitSpec(this, _eventsModel, {
      writable: true,
      value: null
    });
    ...
    _classPrivateFieldInitSpec(this, _listEventComponent, {
      writable: true,
      value: new _view_list_event_view_js__WEBPACK_IMPORTED_MODULE_1__["default"]()
    });
    ...
    _classPrivateFieldInitSpec(this, _filterType, {
      writable: true,
      value: _const_js__WEBPACK_IMPORTED_MODULE_6__.FilterType.EVERYTHING
    });
    ...
    _classPrivateFieldInitSpec(this, _handleViewAction, {
      ...
      value: (actionType, updateType, update) => {
        switch (actionType) {
          case _const_js__WEBPACK_IMPORTED_MODULE_6__.UserAction.UPDATE_EVENT:
            _classPrivateFieldGet(this, _eventsModel).updateEvent(updateType, update);

            break;

          case _const_js__WEBPACK_IMPORTED_MODULE_6__.UserAction.ADD_EVENT:
            _classPrivateFieldGet(this, _eventsModel).addEvent(updateType, update);

            break;

          case _const_js__WEBPACK_IMPORTED_MODULE_6__.UserAction.DELETE_EVENT:
            _classPrivateFieldGet(this, _eventsModel).deleteEvents(updateType, update);
      ...
      value: (updateType, data) => {
        ...
        switch (updateType) {
          case _const_js__WEBPACK_IMPORTED_MODULE_6__.UpdateType.PATCH:
            ...
            _classPrivateFieldGet(this, _eventPresenters).get(data.id).init(data);

            break;

          case _const_js__WEBPACK_IMPORTED_MODULE_6__.UpdateType.MINOR:
            _classPrivateFieldGet(this, _clearBoard).call(this);

            _classPrivateFieldGet(this, _renderBoard).call(this); // - обновить список (например, когда задача ушла в архив)
          ...
          case _const_js__WEBPACK_IMPORTED_MODULE_6__.UpdateType.MAJOR:
            ...
            _classPrivateFieldGet(this, _renderBoard).call(this); // - обновить всю доску (например, при переключении фильтра)
    ...
    _defineProperty(this, "init", () => {
      (0,_render_js__WEBPACK_IMPORTED_MODULE_10__.render)(_classPrivateFieldGet(this, _menuContainer), _classPrivateFieldGet(this, _menuComponent), _render_js__WEBPACK_IMPORTED_MODULE_10__.RenderPosition.BEFOREEND);

      _classPrivateFieldGet(this, _renderBoard).call(this);
    });

    _defineProperty(this, "createEvent", () => {
      const event = (0,_mock_event_js__WEBPACK_IMPORTED_MODULE_8__.generateEvents)();
      ...
      _classPrivateFieldGet(this, _eventNewPresenter).init(createEventData);
    });

    _classPrivateFieldInitSpec(this, _handleModeChange, {
      writable: true,
      value: () => {
        _classPrivateFieldGet(this, _eventNewPresenter).destroy();
    ...
    _classPrivateFieldInitSpec(this, _renderSort, {
      writable: true,
      value: () => {
        _classPrivateFieldSet(this, _sortComponent, new _view_sort_view_js__WEBPACK_IMPORTED_MODULE_2__["default"](_classPrivateFieldGet(this, _currentSortType)));

        (0,_render_js__WEBPACK_IMPORTED_MODULE_10__.render)(_classPrivateFieldGet(this, _tripContainer), _classPrivateFieldGet(this, _sortComponent), _render_js__WEBPACK_IMPORTED_MODULE_10__.RenderPosition.BEFOREEND);
    ...
    _classPrivateFieldInitSpec(this, _renderListEvent, {
      writable: true,
      value: () => {
        (0,_render_js__WEBPACK_IMPORTED_MODULE_10__.render)(_classPrivateFieldGet(this, _tripContainer), _classPrivateFieldGet(this, _listEventComponent), _render_js__WEBPACK_IMPORTED_MODULE_10__.RenderPosition.BEFOREEND);
      }
    });
    ...
    _classPrivateFieldInitSpec(this, _renderEvent, {
      writable: true,
      value: tripEvent => {
        const eventPresenter = new _event_presenter_js__WEBPACK_IMPORTED_MODULE_4__["default"](_classPrivateFieldGet(this, _listEventComponent), _classPrivateFieldGet(this, _handleViewAction), _classPrivateFieldGet(this, _handleModeChange));
    ...
    _classPrivateFieldInitSpec(this, _renderEvents, {
      writable: true,
      value: events => {
        events.forEach(tripEvent => _classPrivateFieldGet(this, _renderEvent).call(this, tripEvent));
      }
    });
    ...
    _classPrivateFieldInitSpec(this, _renderNoEvents, {
      writable: true,
      value: () => {
        _classPrivateFieldSet(this, _eventEmptyComponent, new _view_event_empty_js__WEBPACK_IMPORTED_MODULE_3__["default"](_classPrivateFieldGet(this, _filterType)));

        (0,_render_js__WEBPACK_IMPORTED_MODULE_10__.render)(_classPrivateFieldGet(this, _tripContainer), _classPrivateFieldGet(this, _eventEmptyComponent), _render_js__WEBPACK_IMPORTED_MODULE_10__.RenderPosition.BEFOREEND);
    ...
    _classPrivateFieldInitSpec(this, _clearBoard, {
      writable: true,
      value: ({
        resetSortType = false
      } = {}) => {
        ...
        _classPrivateFieldGet(this, _eventPresenters).forEach(presenter => presenter.destroy());

        _classPrivateFieldGet(this, _eventPresenters).clear();

        (0,_render_js__WEBPACK_IMPORTED_MODULE_10__.remove)(_classPrivateFieldGet(this, _sortComponent));
        (0,_render_js__WEBPACK_IMPORTED_MODULE_10__.remove)(_classPrivateFieldGet(this, _eventEmptyComponent));

        if (_classPrivateFieldGet(this, _eventEmptyComponent)) {
          (0,_render_js__WEBPACK_IMPORTED_MODULE_10__.remove)(_classPrivateFieldGet(this, _eventEmptyComponent));
        }

        if (resetSortType) {
          _classPrivateFieldSet(this, _currentSortType, _utils_sorting_js__WEBPACK_IMPORTED_MODULE_9__.SortType.DAY.text);
        }
      }
    });
    ...
    _classPrivateFieldInitSpec(this, _renderBoard, {
      ...
      value: () => {
        ...
        _classPrivateFieldGet(this, _renderEvents).call(this, events);
    ...
    _classPrivateFieldSet(this, _eventsModel, eventsModel);

    _classPrivateFieldSet(this, _filterModel, filterModel);

    _classPrivateFieldSet(this, _eventNewPresenter, new _event_new_presentor_js__WEBPACK_IMPORTED_MODULE_5__["default"](_classPrivateFieldGet(this, _listEventComponent), _classPrivateFieldGet(this, _handleViewAction)));

    _classPrivateFieldGet(this, _eventsModel).addObserver(_classPrivateFieldGet(this, _handleModelEvent));
  ...
  get events() {
    ...
    const events = _classPrivateFieldGet(this, _eventsModel).events;

    const filteredEvents = _utils_filter_js__WEBPACK_IMPORTED_MODULE_7__.filter[_classPrivateFieldGet(this, _filterType)](events);

    switch (_classPrivateFieldGet(this, _currentSortType)) {
      case _utils_sorting_js__WEBPACK_IMPORTED_MODULE_9__.SortType.DAY.text:
        return filteredEvents.sort(_utils_sorting_js__WEBPACK_IMPORTED_MODULE_9__.sortEventDate);

      case _utils_sorting_js__WEBPACK_IMPORTED_MODULE_9__.SortType.TIME.text:
        return filteredEvents.sort(_utils_sorting_js__WEBPACK_IMPORTED_MODULE_9__.sortEventTime);

      case _utils_sorting_js__WEBPACK_IMPORTED_MODULE_9__.SortType.PRICE.text:
        return filteredEvents.sort(_utils_sorting_js__WEBPACK_IMPORTED_MODULE_9__.sortEventPrice);
    }
...
/* harmony export */   "isDatesEqual": () => (/* binding */ isDatesEqual)
/* harmony export */ });
/* harmony import */ var dayjs__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! dayjs */ "./node_modules/dayjs/dayjs.min.js");
/* harmony import */ var dayjs__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(dayjs__WEBPACK_IMPORTED_MODULE_0__);
...
const isDatesEqual = (dateA, dateB) => dateA === null && dateB === null || dayjs__WEBPACK_IMPORTED_MODULE_0___default()(dateA).isSame(dateB, 'D');
...
const filter = {
  [_const__WEBPACK_IMPORTED_MODULE_0__.FilterType.EVERYTHING]: events => events,
  [_const__WEBPACK_IMPORTED_MODULE_0__.FilterType.FUTURE]: events => events.filter(event => dayjs__WEBPACK_IMPORTED_MODULE_1___default()().isBefore(dayjs__WEBPACK_IMPORTED_MODULE_1___default()(event.date.dataBeginEvent))),
  [_const__WEBPACK_IMPORTED_MODULE_0__.FilterType.PAST]: events => events.filter(event => dayjs__WEBPACK_IMPORTED_MODULE_1___default()().isAfter(dayjs__WEBPACK_IMPORTED_MODULE_1___default()(event.date.dataBeginEvent)))
};
...
const sortEventDate = (taskA, taskB) => dayjs__WEBPACK_IMPORTED_MODULE_0___default()(taskA.date.dataBeginEvent).diff(dayjs__WEBPACK_IMPORTED_MODULE_0___default()(taskB.date.dataBeginEvent));
...
/* harmony import */ var _mock_event_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../mock/event.js */ "./src/mock/event.js");
...
const createTripEditPoint = (event = {}) => {
  ...
  dataBeginEvent = dayjs__WEBPACK_IMPORTED_MODULE_0___default()(date.dataBeginEvent).format('YY/MM/DD HH:mm');
  dataEndEvent = dayjs__WEBPACK_IMPORTED_MODULE_0___default()(date.dataEndEvent).format('YY/MM/DD HH:mm');
  ...
  constructor(editPoint) {
    ...
    _classPrivateFieldInitSpec(this, _setBeginData, {
      ...
      value: () => {
        ...
        _classPrivateFieldSet(this, _datepicker, (0,flatpickr__WEBPACK_IMPORTED_MODULE_3__["default"])(this.element.querySelector('#event-start-time-1'), {
          enableTime: true,
    ...
    _classPrivateFieldInitSpec(this, _setEndData, {
      ...
      value: () => {
        ...
        _classPrivateFieldSet(this, _datepicker, (0,flatpickr__WEBPACK_IMPORTED_MODULE_3__["default"])(this.element.querySelector('#event-end-time-1'), {
          enableTime: true,
          dateFormat: 'd/m/y H:i',
          defaultDate: currentDate,
    ...
    _classPrivateFieldInitSpec(this, _beginDateChangeHandler, {
      ...
      value: ([userDate]) => {
        ...
        this._data.time = (0,_mock_event_js__WEBPACK_IMPORTED_MODULE_2__.generateTime)({
          dataBeginEvent: userDate,
          dataEndEvent: this._data.date.dataEndEvent
        });
      }
    ...
    _defineProperty(this, "setClickRollupHandler", callback => {
      ...
      if (rollupButtonTemplate) {
        rollupButtonTemplate.addEventListener('click', _classPrivateFieldGet(this, _clickHandler));
      }
    });
    ...
    _classPrivateFieldInitSpec(this, _formSubmitHandler, {
      ...
      value: evt => {
        ...
        const filteredOffersData = Array.from(this._data.type.currentType.allOffer).filter(offer => filteredOffersCheked.some(filteredOfferCheked => filteredOfferCheked === offer.title.id));
...
const createTripFilter = currentFilterType => `<form class="trip-filters" action="#" method="get">
...
class FilterView extends _abstract_view_js__WEBPACK_IMPORTED_MODULE_0__["default"] {
  ...
  get template() {
    return createTripFilter(_classPrivateFieldGet(this, _currentFilter));
  }
...
const createTripSort = currentSortType => `<form class="trip-events__trip-sort  trip-sort" action="#" method="get">
  <div class="trip-sort__item  trip-sort__item--day">
    <input id="sort-day" class="trip-sort__input  visually-hidden" type="radio" name="trip-sort" value="sort-day" data-sort-type="${_utils_sorting_js__WEBPACK_IMPORTED_MODULE_1__.SortType.DAY.text}" ${currentSortType === _utils_sorting_js__WEBPACK_IMPORTED_MODULE_1__.SortType.DAY.text ? 'checked' : ''}>
  ...
  <div class="trip-sort__item  trip-sort__item--time">
    <input id="sort-time" class="trip-sort__input  visually-hidden" type="radio" name="trip-sort" value="sort-time" data-sort-type="${_utils_sorting_js__WEBPACK_IMPORTED_MODULE_1__.SortType.TIME.text}" ${currentSortType === _utils_sorting_js__WEBPACK_IMPORTED_MODULE_1__.SortType.TIME.text ? 'checked' : ''}>
    <label class="trip-sort__btn" for="sort-time">Time</label>
  </div>

  <div class="trip-sort__item  trip-sort__item--price">
    <input id="sort-price" class="trip-sort__input  visually-hidden" type="radio" name="trip-sort" value="sort-price" data-sort-type="${_utils_sorting_js__WEBPACK_IMPORTED_MODULE_1__.SortType.PRICE.text}" ${currentSortType === _utils_sorting_js__WEBPACK_IMPORTED_MODULE_1__.SortType.PRICE.text ? 'checked' : ''}>
...
class SortView extends _abstract_view_js__WEBPACK_IMPORTED_MODULE_0__["default"] {
  ...
  get template() {
    return createTripSort(_classPrivateFieldGet(this, _currentSortType));
  }
...
/* harmony import */ var _model_events_model_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./model/events-model.js */ "./src/model/events-model.js");
...
/* harmony import */ var _presentor_filter_presentor_js__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./presentor/filter-presentor.js */ "./src/presentor/filter-presentor.js");
...
const eventsModel = new _model_events_model_js__WEBPACK_IMPORTED_MODULE_2__["default"]();
eventsModel.events = events;
const filterModel = new _model_filter_model_js__WEBPACK_IMPORTED_MODULE_3__["default"]();
const tripPresenter = new _presentor_trip_presenter_js__WEBPACK_IMPORTED_MODULE_1__["default"](tripEvents, siteNavigationElement, eventsModel, filterModel);
const filterPresenter = new _presentor_filter_presentor_js__WEBPACK_IMPORTED_MODULE_4__["default"](siteFilterElement, filterModel);
