...
/***/ "./src/view/add-photo-tape-view.js":
/*!*****************************************!*\
  !*** ./src/view/add-photo-tape-view.js ***!
  \*****************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "default": () => (/* binding */ TripPhoto)
/* harmony export */ });
...
var _tripPhoto = /*#__PURE__*/new WeakMap();
...
class TripPhoto {
  constructor(tripPhoto) {
    ...
    _classPrivateFieldInitSpec(this, _tripPhoto, {
      writable: true,
      value: null
    });

    _classPrivateFieldSet(this, _tripPhoto, tripPhoto);
  }
  ...
  get template() {
    return createTripEditPoint(_classPrivateFieldGet(this, _tripPhoto));
  }
...
/* harmony import */ var _view_add_photo_tape_view_js__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! ./view/add-photo-tape-view.js */ "./src/view/add-photo-tape-view.js");
...
(0,_render_js__WEBPACK_IMPORTED_MODULE_11__.render)(siteNavigationElement, new _view_menu_view_js__WEBPACK_IMPORTED_MODULE_0__["default"]().element, _render_js__WEBPACK_IMPORTED_MODULE_11__.RenderPosition.BEFOREEND);
const siteFilterElement = siteHeader.querySelector('.trip-controls__filters');
(0,_render_js__WEBPACK_IMPORTED_MODULE_11__.render)(siteFilterElement, new _view_filter_view_js__WEBPACK_IMPORTED_MODULE_1__["default"]().element, _render_js__WEBPACK_IMPORTED_MODULE_11__.RenderPosition.BEFOREEND);
...
(0,_render_js__WEBPACK_IMPORTED_MODULE_11__.render)(siteMainElement, sortView.element, _render_js__WEBPACK_IMPORTED_MODULE_11__.RenderPosition.BEFOREEND);
const listEventComponent = new _view_list_event_view_js__WEBPACK_IMPORTED_MODULE_2__["default"]();
(0,_render_js__WEBPACK_IMPORTED_MODULE_11__.render)(siteMainElement, listEventComponent.element, _render_js__WEBPACK_IMPORTED_MODULE_11__.RenderPosition.BEFOREEND);
...
const renderEvent = (eventListElement, event) => {
  ...
  eventComponent.element.querySelector('.event__rollup-btn').addEventListener('click', () => {
    ...
    for (let i = 0; i < event.offers.length; i++) {
      (0,_render_js__WEBPACK_IMPORTED_MODULE_11__.render)(availableOffers, new _view_offer_edit_and_new_point_js__WEBPACK_IMPORTED_MODULE_5__["default"](event.offers[i]).element, _render_js__WEBPACK_IMPORTED_MODULE_11__.RenderPosition.BEFOREEND);
    }
  ...
  (0,_render_js__WEBPACK_IMPORTED_MODULE_11__.render)(eventListElement, eventComponent.element, _render_js__WEBPACK_IMPORTED_MODULE_11__.RenderPosition.BEFOREEND);
};
...
if (routes.length === 0) {
  (0,_render_js__WEBPACK_IMPORTED_MODULE_11__.render)(tripEventsSection, eventEmptyComponent.element, _render_js__WEBPACK_IMPORTED_MODULE_11__.RenderPosition.BEFOREEND);
  siteList.remove();
...
for (let i = 0; i < routeCount; i++) {
  for (let j = 0; j < routes[i].offers.length; j++) {
    (0,_render_js__WEBPACK_IMPORTED_MODULE_11__.render)(selectedOffers[i], new _view_event_offer_view_js__WEBPACK_IMPORTED_MODULE_4__["default"](routes[i].offers[j]).element, _render_js__WEBPACK_IMPORTED_MODULE_11__.RenderPosition.BEFOREEND);
  }
}
})();
